	...
	internal class ParsezDetail
	{
		...
		private static void GetzDetail(Card card)
		{
			...
			if (webdata.Contains("Other Variations"))
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card zVar:", ex);
				}
			}
			#endregion
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card zName:", ex);
			}
			#endregion
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card zType:", ex);
			}
			#endregion
			...
			if (webdata.IndexOf("Flavor Text:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card zFlavor:", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Card Text:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card zText:", ex);
				}
			}
			else
			{
			...
			if (card.IsDoubleFaced())
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card zbName:", ex);
				}
				#endregion
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card zbType:", ex);
				}
				#endregion
				...
				if (webdata.IndexOf("Flavor Text:") > 0 && webdata.IndexOf("Flavor Text:") != webdata.LastIndexOf("Flavor Text:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card zbFlavor:", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Card Text:") > 0 && webdata.IndexOf("Card Text:") != webdata.LastIndexOf("Card Text:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card zbText:", ex);
					}
				}
				else
				{
