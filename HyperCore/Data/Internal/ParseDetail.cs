	...
	internal class ParseDetail
	{
		...
		public static void Parse(Card card)
		{
			...
			if (webdata.Contains("Other Variations"))
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card Var", ex);
				}
			}
			else
			{
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card Name", ex);
			}
			#endregion
			...
			if (webdata.IndexOf("Converted Mana Cost:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card CMC", ex);
				}
			}
			else
			{
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card Type", ex);
			}
			#endregion
			...
			if (webdata.IndexOf("Flavor Text:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card Flavor", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("P/T:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card PT", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Loyalty:") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card Loyalty", ex);
				}
			}
			else
			{
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card Rarity", ex);
			}
			#endregion
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card Number", ex);
			}
			#endregion
			...
			{
				throw new ParseException(card, "Parsing Error happended when parsing card Artist", ex);
			}
			#endregion
			...
			if (webdata.IndexOf("Hide Rulings") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card Rulings", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("class=\"textRatingValue\">") > 0)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card Rating", ex);
				}
			}
			else
			{
			...
			if (isdoubleface)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card bID", ex);
				}
				#endregion
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card bName", ex);
				}
				#endregion
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card bType", ex);
				}
				#endregion
				...
				if (webdata.IndexOf("Card Text:") > 0 && webdata.IndexOf("Card Text:") != webdata.LastIndexOf("Card Text:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card bText", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Flavor Text:") > 0 && webdata.IndexOf("Flavor Text:") != webdata.LastIndexOf("Flavor Text:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card bFlavor", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("P/T:") > 0 && webdata.IndexOf("P/T:") != webdata.LastIndexOf("P/T:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card bPT", ex);
					}
				}
				else
				{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card bRarity", ex);
				}
				#endregion
				...
				if (webdata.Contains("Card Number:") && webdata.IndexOf("Card Number:") != webdata.LastIndexOf("Card Number:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card bNumber", ex);
					}
				}
				else
				{
				...
				if (webdata.LastIndexOf("Color Indicator:") > 0)
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card bColor", ex);
					}
				}
				else
				{
			...
			else if (issplit)
			{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card sType", ex);
				}
				#endregion
				...
				if (webdata.IndexOf("Converted Mana Cost:") > 0 && webdata.IndexOf("Converted Mana Cost:") != webdata.LastIndexOf("Converted Mana Cost:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card sCMC", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Mana Cost:") > 0 && webdata.IndexOf("Mana Cost:") != webdata.LastIndexOf("Mana Cost:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card sCost", ex);
					}
				}
				else
				{
				...
				{
					throw new ParseException(card, "Parsing Error happended when parsing card sRarity", ex);
				}
				#endregion
				...
				if (webdata.Contains("Card Number:") && webdata.IndexOf("Card Number:") != webdata.LastIndexOf("Card Number:"))
				{
					...
					{
						throw new ParseException(card, "Parsing Error happended when parsing card sNumber", ex);
					}
				}
				else
				{
