	...
	internal class ParseDetail : ICardParse
	{
		...
		public void Parse(Common.Card card, Common.LANGUAGE lang)
		{
			...
			if (webdata.Contains("Other Variations"))
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Var", ex);
				}
			}
			else
			{
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card Name", ex);
			}
			...
			if (webdata.IndexOf("Mana Cost:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Cost", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Converted Mana Cost:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card CMC", ex);
				}
			}
			else
			{
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card Type", ex);
			}
			...
			if (webdata.IndexOf("Card Text:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Text", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Flavor Text:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Flavor", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("P/T:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card PT", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Loyalty:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Loyalty", ex);
				}
			}
			else
			{
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card Rarity", ex);
			}
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card Number", ex);
			}
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card Artist", ex);
			}
			...
			if (webdata.IndexOf("Hide Rulings") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Rulings", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("class=\"textRatingValue\">") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card Rating", ex);
				}
			}
			else
			{
			...
			if (isdoubleface)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card bID", ex);
				}
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card bName", ex);
				}
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card bType", ex);
				}
				...
				if (webdata.IndexOf("Card Text:") > 0 && webdata.IndexOf("Card Text:") != webdata.LastIndexOf("Card Text:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card bText", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Flavor Text:") > 0 && webdata.IndexOf("Flavor Text:") != webdata.LastIndexOf("Flavor Text:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card bFlavor", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("P/T:") > 0 && webdata.IndexOf("P/T:") != webdata.LastIndexOf("P/T:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card bPT", ex);
					}
				}
				else
				{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card bRarity", ex);
				}
				...
				if (webdata.Contains("Card Number:") && webdata.IndexOf("Card Number:") != webdata.LastIndexOf("Card Number:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card bNumber", ex);
					}
				}
				else
				{
				...
				if (webdata.LastIndexOf("Color Indicator:") > 0)
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card bColor", ex);
					}
				}
				else
				{
			...
			else if (issplit)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card sType", ex);
				}
				...
				if (webdata.IndexOf("Converted Mana Cost:") > 0 && webdata.IndexOf("Converted Mana Cost:") != webdata.LastIndexOf("Converted Mana Cost:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card sCMC", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Mana Cost:") > 0 && webdata.IndexOf("Mana Cost:") != webdata.LastIndexOf("Mana Cost:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card sCost", ex);
					}
				}
				else
				{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card sRarity", ex);
				}
				...
				if (webdata.Contains("Card Number:") && webdata.IndexOf("Card Number:") != webdata.LastIndexOf("Card Number:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card sNumber", ex);
					}
				}
				else
				{
