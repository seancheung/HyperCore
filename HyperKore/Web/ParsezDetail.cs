	...
	internal class ParsezDetail : ICardParse
	{
		...
		private void GetzDetail(Card card)
		{
			...
			if (webdata.Contains("Other Variations"))
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zVar:", ex);
				}
			}
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card zName:", ex);
			}
			...
			{
				throw new ParsingXception(card, "Parsing Error happended when parsing card zType:", ex);
			}
			...
			if (webdata.IndexOf("Flavor Text:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zFlavor:", ex);
				}
			}
			else
			{
			...
			if (webdata.IndexOf("Card Text:") > 0)
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zText:", ex);
				}
			}
			else
			{
			...
			if (card.IsDoubleFaced())
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zbName:", ex);
				}
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zbType:", ex);
				}
				...
				if (webdata.IndexOf("Flavor Text:") > 0 && webdata.IndexOf("Flavor Text:") != webdata.LastIndexOf("Flavor Text:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card zbFlavor:", ex);
					}
				}
				else
				{
				...
				if (webdata.IndexOf("Card Text:") > 0 && webdata.IndexOf("Card Text:") != webdata.LastIndexOf("Card Text:"))
				{
					...
					{
						throw new ParsingXception(card, "Parsing Error happended when parsing card zbText:", ex);
					}
				}
				else
				{
			...
			else if (card.IsSplit())
			{
				...
				{
					throw new ParsingXception(card, "Parsing Error happended when parsing card zsType:", ex);
				}
			}
		}
	}
